<template>
    <main>
        ...
        <div class="row m-5">
            <h2 class="text-white col-xl-11 ">Edit Program // {{program.name}}</h2>
            <button @click="editProgram" id="deploy" class=" col-xl-1" >Save</button>
        </div>
                ...
                <div class="card m-2">
                    ...
                    <div class="form-group row mt-3 mb-0">
                            ...
                            <div class="col-xl-4">
                                ...
                                <b-form-file  ref="file" id="file" name="file" :placeholder="program.logo" accept="image/*"></b-form-file>
                            </div>
            ...
            loadProgram(){
                this.$http
                    ...
                    .then(response => {
                        ...
                        this.program.info = JSON.parse(this.program.description).info
                        let begin_at = new Date(this.program.begin_at).toISOString()
                        let finish_at = new Date(this.program.finish_at).toISOString()
                        this.program.begin_at = begin_at.split(':')[0]+':'+begin_at.split(':')[1]
                        this.program.finish_at = finish_at.split(':')[0]+':'+finish_at.split(':')[1]
                        this.program.p1 = JSON.parse(this.program.description).rewards.p1
                        this.program.p2 = JSON.parse(this.program.description).rewards.p2
                        this.program.p3 = JSON.parse(this.program.description).rewards.p3
                        this.program.p4 = JSON.parse(this.program.description).rewards.p4
                        this.program.p5 = JSON.parse(this.program.description).rewards.p5
