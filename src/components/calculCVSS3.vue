...
<div class="row m-0 w-100">
                ...
                <button class="severityBtn ml-auto" :class="severityRating.name"
                    ...
                    {{severityRating.name}}<b-badge variant="light" class="p-1 ml-1">{{score}}</b-badge>
                </button>
...
<script>
    import { baseMatrices,severityRatings,weight,exploitabilityCoefficient,scopeCoefficient } from "@/assets/helpers/cvss";
    export default {
        name: "calculCVSS3",
        data(){
            return{
